...
from model.CNNmodel1D import CNNmodel1D
from model.ViTmodel import ViTmodel
from model.MLPmix import MLPMixer
from model.FoTmodel import FoTmodel
...
def main(cfg) -> None:
    ...
    if cfg.model.name == 'Transformer':
        ...
        model = MLPMixer(
            ...
            tokens_hidden_dim=cfg.model.tokens_hidden_dim
        )

    elif cfg.model.name == 'FoT':
        model = FoTmodel(
            font_dim=cfg.model.font_dim,
            word_size=cfg.model.word_size,
            num_classes=cfg.model.num_classes,
