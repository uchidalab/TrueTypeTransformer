...
# python src/main_CNN2D.py method=Res_googlefonts_character_16 batch_size=512 model=CNN2D model.img_size=16 model.num_classes=26 label_request=character
# python src/main_CNN2D.py method=Res_googlefonts_character_32 batch_size=512 model=CNN2D model.img_size=32 model.num_classes=26 label_request=character
# python src/main_CNN2D.py method=Res_googlefonts_character_64 batch_size=512 model=CNN2D model.img_size=64 model.num_classes=26 label_request=character
# python src/main_CNN2D.py method=Res_googlefonts_character_128 batch_size=512 model=CNN2D model.img_size=128 model.num_classes=26 label_request=character
# python src/main_CNN2D.py method=Res_googlefonts_character_256 batch_size=512 model=CNN2D model.img_size=256 model.num_classes=26 label_request=character

# python src/main_CNN2D.py method=Res_googlefonts_style_16 batch_size=512 model=CNN2D model.img_size=16 model.num_classes=4 label_request=style
# python src/main_CNN2D.py method=Res_googlefonts_style_32 batch_size=512 model=CNN2D model.img_size=32 model.num_classes=4 label_request=style
# python src/main_CNN2D.py method=Res_googlefonts_style_64 batch_size=512 model=CNN2D model.img_size=64 model.num_classes=4 label_request=style
# python src/main_CNN2D.py method=Res_googlefonts_style_128 batch_size=512 model=CNN2D model.img_size=128 model.num_classes=4 label_request=style
# python src/main_CNN2D.py method=Res_googlefonts_style_256 batch_size=512 model=CNN2D model.img_size=256 model.num_classes=4 label_request=style
